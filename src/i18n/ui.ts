...
export const ui = {
  ko: {
    ...
    'tickets.desc': '행사가 모두 종료되었습니다! 참가해주신 모든 분들께 감사드립니다. 발표 자료는 세션 상세 페이지에 업로드되며, 인프런에서 영상을 얼리 엑세스로 구매하실 수 있습니다. 해당 영상은 2024년 2분기에 YouTube에도 공개 예정입니다.',
  ...
  en: {
    ...
    'tickets.desc': 'The event is now ended. Thank you to everyone who participated. Presentations and videos will be released on the session details page and YouTube by Q2 2024, or you can purchase an early-access version of video at Inflearn(English not supported)',
